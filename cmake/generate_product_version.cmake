...
function(generate_product_version outfiles)
    ...
    set (_VersionInfoFile ${CMAKE_CURRENT_BINARY_DIR}/version_information.h)
    set (_VersionResourceFile ${CMAKE_CURRENT_BINARY_DIR}/version.rc)
    configure_file(
        ${GenerateProductVersionCurrentDir}/version_information.in
        ${_VersionInfoFile}
        @ONLY)
    configure_file(
        ${GenerateProductVersionCurrentDir}/version.rc
